...
describe('useViewportWs', () => {
  ...
  it('sends SUBSCRIBE on open when bounds are available', () => {
    ...
    expect(msg.payload.bounds.min_lat).toBe(-2)
    expect(msg.payload.bounds.max_lat).toBe(0)
    expect(msg.payload.bounds.min_lng).toBe(35)
    expect(msg.payload.bounds.max_lng).toBe(37)
